...
function App() {
  //instace of setting individual value of each variable in the object we can set only requried variable 
  //value and use spreate operator for rest of the variable 
